...
#include "ltls.h"
#include "ltls_single.h"
#include "ltls_multilabel.h"
...
{ new_options(all, "Reduction options, use [option] --help for more info");
  ...
  all.reduction_stack.push_back(ltls_setup);
  all.reduction_stack.push_back(ltls_single_setup);
  all.reduction_stack.push_back(ltls_multilabel_setup);
